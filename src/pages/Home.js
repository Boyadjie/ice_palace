...
const Home = () => {
  return (
    <div className="home" id="home">
      ...
      <Double flexDirection="row" imageName="rainbow.png" link="/arc-en-ciel" title="Glace Arc En Ciel" paragraphOne="Découvrez notre glace multicolore aux multiples parfums. Retrouvez les goûts de la framboise, banane, fraise ainsi que des bonbons “schtroumpf”. Ce mélange de saveurs vous procurera un délicieux gout de friandise." paragraphTwo="Sans ajout de colorant, arôme ou conservateur, notre glace est directement fabriquée dans nos ateliers." />
      <Double flexDirection="row-reverse" imageName="gold.png" link="/or" title="Glace Or" paragraphOne="Découvrez notre glace intensément noire au sésame noir parsemée de feuille d'or. Cette crème glacée est réalisée avec une pure pâte de sésame noir du Japon. Ces graines au gout fumé apportent une légère tonalité de bois de réglisse." paragraphTwo="Sans colorant, arôme ou conservateur, notre glace est directement fabriquée dans nos ateliers." />
